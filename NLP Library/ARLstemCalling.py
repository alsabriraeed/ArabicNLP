...
#        print(text)
    ...
    def main(self):
        ...
        datasettypes = ['long','short']# ,'short', 'long'
...
#                    path = '/home1/raeed/Arabic dataset prepared/'+dataset+r'/'+version+'/'+datasettype+'/'
                    ...
                    name = dataset
                    file = open(path+ name +'1.txt',"w",encoding="utf-8-sig")
                    filel = open(path+name +'1_label.txt',"w",encoding="utf-8-sig")
                    with open(path+name +'c.txt', 'r',encoding="utf-8-sig") as f,open(path+name +'_label.txt', 'r',encoding="utf-8-sig") as fl:
