...
import BuildingtermdocumentMatrix
...
#    print(vec.vocabulary_)
    ...
    X = obj.transform(X)
    print(X.shape)
    weighted_array = X.toarray()
    weight = np.asarray(weighted_array).sum(axis=0)
    weight = BuildingtermdocumentMatrix.normalize(weight)
    print(weight.shape)
        #    normalize
    ...
    BuildingtermdocumentMatrix.writingTotalweighttofile(weight,path + 'okapibm25.txt')
