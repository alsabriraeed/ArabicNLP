...
class arbic_clean_text:
    ...
    def load_stop_words(self):
        ...
        # path = r'/home1/raeed/process-arabic-text-master/stop_words.txt'
    ...
    def main(self):
#        file = open(r'F:\Arabic dataset prepared\arwiki-20180920-corpus.xml/cleanedarwiki-20180920-corpus.txt',"w",encoding="utf8")
#        with open(r'F:\Arabic dataset prepared\arwiki-20180920-corpus.xml/arwiki-20180920-corpus.txt', 'r',encoding="utf-8-sig") as f:
        file = open(r'F:\Arabic dataset prepared\arwiki-20180920-corpus.xml/cleanedarwiki-20180920-corpus.txt',"w",encoding="utf8")
        with open(r'F:\Arabic dataset prepared\arwiki-20180920-corpus.xml/arwiki-20180920-corpus.txt', 'r',encoding="utf-8-sig") as f:
