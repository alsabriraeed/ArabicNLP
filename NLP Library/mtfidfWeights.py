...
if __name__ == '__main__':
    ...
    datasets =['AlKhaleej'] #,'Akhbarona'
#    datasets =['ArabicAC']
#    datasets =['AlKhaleej','AlArabiya','Akhbarona']
    versions =["version8.1"]
#    versions =["version2.1","version4.1","version5.1","version7.1"]
            ...
            # tfidf new for the paper "Improved TFIDF in big news retrieval: An empirical study"
                for mod in range(len(models)):
                    ...
                    if (models[mod]=='newtfidf'):
                         # newtfidf    
                        weighted_matrix2 = weights.tfidfforpaper(numpy_matrix)
...
#                        print("total_weight3\n",total_weight3)
                        if (datasettype =='short'):
                            writingTotalweighttofile(total_weight3,path +  'mtfidf.txt')
                        elif ( datasettype =='long'):
                            writingtofilewithindices(weighted_matrix2,path + 'singlemtfidf.txt',path + 'singlemtfidfindices.txt')
#                        elif (dataset =='ArabicAC' and datasettype =='long'):
#                            writingtofile( weighted_matrix2,path + 'singlemtfidf.txt')
##                        
