...
class arbic_clean_text:
    ...
    def main(self):
        file = open(r'F:\Arabic dataset prepared\Akhbarona\version7.1\short/Akhbaronac.txt',"w",encoding="utf8")
        filel = open(r'F:\Arabic dataset prepared\Akhbarona\version7.1\short/Akhbarona_label.txt',"w",encoding="utf8")
        with open(r'F:\Arabic dataset prepared\Akhbarona\version7\short/Akhbaronac.txt', 'r',encoding="utf-8-sig") as f,\
        open(r'F:\Arabic dataset prepared\Akhbarona\version7\short/Akhbarona_label.txt', 'r',encoding="utf-8-sig") as fl:
