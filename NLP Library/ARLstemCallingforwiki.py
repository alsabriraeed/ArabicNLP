...
#        print(text)
    ...
    def main(self):
            ...
            path = r'F:\Arabic dataset prepared\arwiki-20180920-corpus.xml/cleanedarwiki-20180920-corpus'
#                    path = '/home1/raeed/Arabic dataset prepared/'+dataset+r'/'+version+'/'+datasettype+'/'

            file = open(path+'NRALS.txt',"w",encoding="utf-8-sig")
            with open(path+'.txt', 'r',encoding="utf-8-sig") as f:
