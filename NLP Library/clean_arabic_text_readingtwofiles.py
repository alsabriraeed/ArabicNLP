...
class arbic_clean_text:
    ...
    def main(self):
        file = open(r'F:\ArabicDatasets\\Arabiyashort\version1/Arabiyac.txt',"w",encoding="utf8")
        filel = open(r'F:\ArabicDatasets\\Arabiyashort\version1/Arabiyac_label.txt',"w",encoding="utf8")
        with open(r'F:\ArabicDatasets\\Arabiyashort\version1/Arabiya.txt', 'r',encoding="utf-8-sig") as f,\
                open(r'F:\ArabicDatasets\\Arabiyashort\version1/Arabiya_label.txt', 'r',encoding="utf-8-sig") as fl:
