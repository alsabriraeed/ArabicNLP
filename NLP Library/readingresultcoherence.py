...
#        return instances
    ...
    alltext=[]
    str1 = 'Model_Name'+'|'+'Coherencecv'+'|'+'coh_Std'
...
#        print(alltext[1][1])
    ...
    def writingtofile(self,alltext,path,dataset,version,datasettype):
        filefortext = open(path+dataset+'_'+ version+'_'+datasettype +'_coherence.txt',"w",encoding="utf8")
...
#        print(len(alltext))
    ...
    def listthefolders(self):
         datasets =['AlArabiya','Akhbarona']#'ArabicAC','AlKhaleej','AlArabiya','Akhbarona'
