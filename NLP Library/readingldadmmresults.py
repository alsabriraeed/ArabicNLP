...
#         datasets =['Akhbarona']
         ...
         for dataset in datasets:
             for version in versions:
                 ...
                 path = 'F:\Arabic_dataset_prepared/'+dataset+'/'+version+'/'+datasettype+'/'
...
#                 path = '/nuist/scratch/wangwen/wangwen_ali/raeed/Arabic_dataset_prepared/'+dataset+r'/'+version+'/'+datasettype+'/'
                 resultpath = 'F:\Arabic_dataset_prepared/ldadmmresult/'
...
#                 np.random.shuffle(self.alltext)
                     self.writingtofile(self.alltext,resultpath,dataset,version,datasettype)
