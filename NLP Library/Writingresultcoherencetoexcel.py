# -*- coding: utf-8 -*-
"""
Created on Tue Nov 19 09:55:15 2019
...
#				"version4.1","version5","version5.1","version6","version6.1","version7","version7.1"],'AlKhaleej','AlArabiya','Akhbarona'
versions =["version2.1","version3.1",
				"version4.1","version5.1","version7.1"]
datasets =['AlArabiya','Akhbarona'] #,'AlArabiya','Akhbarona'
#datasets =['ArabicAC']
...
#        path = '/home1/raeed/Arabic dataset prepared/'+dataset+'/'+version+'/'+datasettype+'/'
        result = pd.read_csv(path + dataset+'_'+ version+'_'+datasettype +'_coherence.txt',  sep='|')
#        , index_col='Model_Name'
#        print(result.head(20))
#        print(result.shape[0])
#        print(result.Accuracy.max())
        result.to_excel (path1 + dataset+'_'+ version+'_'+datasettype +'_coherence.xlsx', index = None, header=True)
